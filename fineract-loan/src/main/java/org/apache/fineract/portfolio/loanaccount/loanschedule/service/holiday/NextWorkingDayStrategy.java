...
/**
 * Strategy that moves repayment dates that fall on holidays or non-working days to the next working day.
 */
@Component
public class NextWorkingDayStrategy extends AbstractHolidayStrategy {
