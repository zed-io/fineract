...
/**
 * Unit tests for the DecliningBalanceEqualInstallmentsCalculationEngine.
 */
public class DecliningBalanceEqualInstallmentsCalculationEngineTest {

    private DecliningBalanceEqualInstallmentsCalculationEngine engine;
    private MathContext mathContext;
    private MonetaryCurrency currency;

    @BeforeEach
    public void setup() {
        engine = new DecliningBalanceEqualInstallmentsCalculationEngine();
    ...
    public void testCalculateInstallmentAmount() {
        ...
        LoanInstallmentCalculationParameters params = new LoanInstallmentCalculationParameters.Builder()
                ...
                .withAmortizationMethod(AmortizationMethod.EQUAL_INSTALLMENTS)
                .build();
        ...
        // For a 12-month loan at 12%, the PMT calculation should give us monthly payments of ~888.49
        // Principal = Payment - Interest = 888.49 - 98.63 = 789.86
        assertEquals(new BigDecimal("789.86"), result.getPrincipal().getAmount().setScale(2, RoundingMode.HALF_EVEN));
        
        // Total due = Principal + Interest = 789.86 + 98.63 = 888.49
        assertEquals(new BigDecimal("888.49"), result.getTotalDue().getAmount().setScale(2, RoundingMode.HALF_EVEN));
    }
    ...
    public void testGetType() {
        assertEquals(LoanCalculationEngineType.DECLINING_BALANCE_EQUAL_INSTALLMENTS, engine.getType());
    }
}